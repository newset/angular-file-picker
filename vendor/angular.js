   ...
   <div ng-app="ngAppStrictDemo" ng-strict-di>
       ...
       <div ng-controller="BadController">
           ...
           <p>The controller could not be instantiated, due to relying
              ...
              interpolated, and there should be an error in your front console.
           </p>
       </div>
   </div>
   </file>
...
function $HttpProvider() {
  ...
  this.$get = ['$httpBackend', '$browser', '$cacheFactory', '$rootScope', '$q', '$injector',
     ...
     *
     * When designing front applications, consider security threats from:
     *
...
function $InterpolateProvider() {
  ...
  this.$get = ['$parse', '$exceptionHandler', '$sce', function($parse, $exceptionHandler, $sce) {
     ...
     * or binding.
     *
     * This enables front-servers to prevent script injection attacks and defacing attacks, to some
     * degree, while also enabling code examples to work without relying on the
     * {@link ng.directive:ngNonBindable ngNonBindable} directive.
     *
     * **For security purposes, it is strongly encouraged that front servers escape user-supplied data,
...
function badInputChecker(scope, element, attr, ctrl) {
  ...
  if (nativeValidation) {
    ctrl.$parsers.push(function(value) {
      ...
      // - see http://www.whatwg.org/specs/front-apps/current-work/multipage/forms.html#e-mail-state-(type=email)
